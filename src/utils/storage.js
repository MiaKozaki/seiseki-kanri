...
export const INITIAL_DATA = {
  ...
  examTypes: [
    { id: 'et1', schoolId: 's1', subject: '小学国語' },
    { id: 'et2', schoolId: 's1', subject: '小学算数' },
    { id: 'et3', schoolId: 's2', subject: '小学理科' },
    { id: 'et4', schoolId: 's2', subject: '小学社会' },
    { id: 'et5', schoolId: 's3', subject: '小学国語' },
  ...
  tasks: [
    { id: 't1', name: '〇〇中学校 小学国語 第1回', subject: '小学国語', requiredHours: 12, deadline: '2026-03-05', status: 'pending', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-02-18T00:00:00.000Z' },
    { id: 't2', name: '〇〇中学校 小学算数 第1回', subject: '小学算数', requiredHours: 8, deadline: '2026-03-05', status: 'pending', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-02-18T00:00:00.000Z' },
    { id: 't3', name: '△△中学校 小学理科 第1回', subject: '小学理科', requiredHours: 10, deadline: '2026-03-07', status: 'pending', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-02-18T00:00:00.000Z' },
    { id: 't4', name: '△△中学校 小学社会 第1回', subject: '小学社会', requiredHours: 6, deadline: '2026-03-07', status: 'pending', sheetsUrl: '', workType: '解答出し', createdAt: '2026-02-18T00:00:00.000Z' },
    // 試験種処理デモ用 — submitted（検証待ち/検証中）
    { id: 't5', name: '〇〇中学校 小学国語 第2回', subject: '小学国語', requiredHours: 10, deadline: '2026-03-10', status: 'submitted', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-02-20T00:00:00.000Z' },
    { id: 't6', name: '△△中学校 小学算数 第2回', subject: '小学算数', requiredHours: 8, deadline: '2026-03-08', status: 'submitted', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-02-20T00:00:00.000Z' },
    { id: 't7', name: '□□中学校 小学理科 第2回', subject: '小学理科', requiredHours: 12, deadline: '2026-03-12', status: 'submitted', sheetsUrl: '', workType: '部分点', createdAt: '2026-02-22T00:00:00.000Z' },
    { id: 't8', name: '〇〇中学校 小学社会 第2回', subject: '小学社会', requiredHours: 6, deadline: '2026-03-09', status: 'submitted', sheetsUrl: '', workType: '解答出し', createdAt: '2026-02-21T00:00:00.000Z' },
    { id: 't9', name: '□□中学校 小学国語 第3回', subject: '小学国語', requiredHours: 14, deadline: '2026-03-14', status: 'submitted', sheetsUrl: '', workType: 'tensakitインポート', createdAt: '2026-02-23T00:00:00.000Z' },
    // 試験種処理デモ用 — approved（検証済み）
    { id: 't10', name: '△△中学校 小学算数 第1回', subject: '小学算数', requiredHours: 8, deadline: '2026-02-28', status: 'approved', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-02-15T00:00:00.000Z' },
    { id: 't11', name: '〇〇中学校 小学理科 第1回', subject: '小学理科', requiredHours: 10, deadline: '2026-03-01', status: 'approved', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-02-16T00:00:00.000Z' },
    { id: 't12', name: '□□中学校 小学社会 第1回', subject: '小学社会', requiredHours: 7, deadline: '2026-03-03', status: 'approved', sheetsUrl: '', workType: '部分点', createdAt: '2026-02-17T00:00:00.000Z' },
    // === デモ用追加タスク (100件: t13-t112) ===
    { id: 't13', name: '桜が丘中学校 小学国語 第1回', subject: '小学国語', requiredHours: 4, deadline: '2026-03-10', status: 'assigned', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-01T00:00:00.000Z' },
    { id: 't14', name: '青山中学校 小学算数 第1回', subject: '小学算数', requiredHours: 5, deadline: '2026-03-11', status: 'assigned', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-01T00:00:00.000Z' },
    { id: 't15', name: '城北中学校 小学理科 第1回', subject: '小学理科', requiredHours: 6, deadline: '2026-03-12', status: 'approved', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-02T00:00:00.000Z' },
    { id: 't16', name: '西園中学校 小学社会 第1回', subject: '小学社会', requiredHours: 7, deadline: '2026-03-13', status: 'pending', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-03T00:00:00.000Z', viking: true },
    ...
    { id: 't18', name: '大阪附属中 小学国語 第1回', subject: '小学国語', requiredHours: 9, deadline: '2026-03-15', status: 'in_progress', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-05T00:00:00.000Z' },
    { id: 't19', name: '名古屋中学校 小学算数 第1回', subject: '小学算数', requiredHours: 10, deadline: '2026-03-16', status: 'pending', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-06T00:00:00.000Z' },
    { id: 't20', name: '横浜中学校 小学理科 第1回', subject: '小学理科', requiredHours: 11, deadline: '2026-03-17', status: 'submitted', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-07T00:00:00.000Z' },
    { id: 't21', name: '神戸中学校 小学社会 第1回', subject: '小学社会', requiredHours: 12, deadline: '2026-03-18', status: 'pending', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-08T00:00:00.000Z' },
    ...
    { id: 't23', name: '埼玉中学校 小学国語 第1回', subject: '小学国語', requiredHours: 14, deadline: '2026-03-20', status: 'submitted', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-10T00:00:00.000Z' },
    { id: 't24', name: '広島中学校 小学算数 第1回', subject: '小学算数', requiredHours: 15, deadline: '2026-03-21', status: 'pending', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-11T00:00:00.000Z' },
    { id: 't25', name: '桜が丘中学校 小学理科 第2回', subject: '小学理科', requiredHours: 16, deadline: '2026-03-22', status: 'in_progress', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-12T00:00:00.000Z' },
    { id: 't26', name: '青山中学校 小学社会 第2回', subject: '小学社会', requiredHours: 17, deadline: '2026-03-23', status: 'in_progress', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-13T00:00:00.000Z' },
    ...
    { id: 't28', name: '西園中学校 小学国語 第2回', subject: '小学国語', requiredHours: 19, deadline: '2026-03-25', status: 'in_progress', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-15T00:00:00.000Z', viking: true },
    { id: 't29', name: '東京学園 小学算数 第2回', subject: '小学算数', requiredHours: 20, deadline: '2026-03-26', status: 'in_progress', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-16T00:00:00.000Z' },
    { id: 't30', name: '大阪附属中 小学理科 第2回', subject: '小学理科', requiredHours: 4, deadline: '2026-03-27', status: 'approved', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-17T00:00:00.000Z' },
    { id: 't31', name: '名古屋中学校 小学社会 第2回', subject: '小学社会', requiredHours: 5, deadline: '2026-03-28', status: 'submitted', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-18T00:00:00.000Z' },
    ...
    { id: 't33', name: '神戸中学校 小学国語 第2回', subject: '小学国語', requiredHours: 7, deadline: '2026-03-30', status: 'assigned', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-20T00:00:00.000Z' },
    { id: 't34', name: '千葉中学校 小学算数 第2回', subject: '小学算数', requiredHours: 8, deadline: '2026-03-31', status: 'pending', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-21T00:00:00.000Z' },
    { id: 't35', name: '埼玉中学校 小学理科 第2回', subject: '小学理科', requiredHours: 9, deadline: '2026-04-01', status: 'assigned', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-22T00:00:00.000Z' },
    { id: 't36', name: '広島中学校 小学社会 第2回', subject: '小学社会', requiredHours: 10, deadline: '2026-04-02', status: 'approved', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-23T00:00:00.000Z' },
    ...
    { id: 't38', name: '青山中学校 小学国語 第3回', subject: '小学国語', requiredHours: 12, deadline: '2026-04-04', status: 'in_progress', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-25T00:00:00.000Z' },
    { id: 't39', name: '城北中学校 小学算数 第3回', subject: '小学算数', requiredHours: 13, deadline: '2026-04-05', status: 'submitted', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-26T00:00:00.000Z' },
    { id: 't40', name: '西園中学校 小学理科 第3回', subject: '小学理科', requiredHours: 14, deadline: '2026-04-06', status: 'assigned', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-27T00:00:00.000Z', viking: true },
    { id: 't41', name: '東京学園 小学社会 第3回', subject: '小学社会', requiredHours: 15, deadline: '2026-04-07', status: 'approved', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-28T00:00:00.000Z' },
    ...
    { id: 't43', name: '名古屋中学校 小学国語 第3回', subject: '小学国語', requiredHours: 17, deadline: '2026-04-09', status: 'pending', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-30T00:00:00.000Z' },
    { id: 't44', name: '横浜中学校 小学算数 第3回', subject: '小学算数', requiredHours: 18, deadline: '2026-04-10', status: 'in_progress', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-31T00:00:00.000Z' },
    { id: 't45', name: '神戸中学校 小学理科 第3回', subject: '小学理科', requiredHours: 19, deadline: '2026-04-11', status: 'in_progress', sheetsUrl: '', workType: '解答出し', createdAt: '2026-04-01T00:00:00.000Z' },
    { id: 't46', name: '千葉中学校 小学社会 第3回', subject: '小学社会', requiredHours: 20, deadline: '2026-04-12', status: 'submitted', sheetsUrl: '', workType: '部分点', createdAt: '2026-04-02T00:00:00.000Z' },
    ...
    { id: 't48', name: '広島中学校 小学国語 第3回', subject: '小学国語', requiredHours: 5, deadline: '2026-04-14', status: 'assigned', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-04-04T00:00:00.000Z' },
    { id: 't49', name: '桜が丘中学校 小学算数 第4回', subject: '小学算数', requiredHours: 6, deadline: '2026-04-15', status: 'approved', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-04-05T00:00:00.000Z' },
    { id: 't50', name: '青山中学校 小学理科 第4回', subject: '小学理科', requiredHours: 7, deadline: '2026-04-16', status: 'in_progress', sheetsUrl: '', workType: '解答出し', createdAt: '2026-04-06T00:00:00.000Z' },
    { id: 't51', name: '城北中学校 小学社会 第4回', subject: '小学社会', requiredHours: 8, deadline: '2026-04-17', status: 'approved', sheetsUrl: '', workType: '部分点', createdAt: '2026-04-07T00:00:00.000Z' },
    ...
    { id: 't53', name: '東京学園 小学国語 第4回', subject: '小学国語', requiredHours: 10, deadline: '2026-04-19', status: 'assigned', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-04-09T00:00:00.000Z' },
    { id: 't54', name: '大阪附属中 小学算数 第4回', subject: '小学算数', requiredHours: 11, deadline: '2026-04-20', status: 'pending', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-04-10T00:00:00.000Z' },
    { id: 't55', name: '名古屋中学校 小学理科 第4回', subject: '小学理科', requiredHours: 12, deadline: '2026-04-21', status: 'assigned', sheetsUrl: '', workType: '解答出し', createdAt: '2026-04-11T00:00:00.000Z', viking: true },
    { id: 't56', name: '横浜中学校 小学社会 第4回', subject: '小学社会', requiredHours: 13, deadline: '2026-04-22', status: 'assigned', sheetsUrl: '', workType: '部分点', createdAt: '2026-04-12T00:00:00.000Z' },
    ...
    { id: 't58', name: '千葉中学校 小学国語 第4回', subject: '小学国語', requiredHours: 15, deadline: '2026-04-24', status: 'submitted', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-04-14T00:00:00.000Z' },
    { id: 't59', name: '埼玉中学校 小学算数 第4回', subject: '小学算数', requiredHours: 16, deadline: '2026-04-25', status: 'submitted', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-04-15T00:00:00.000Z' },
    { id: 't60', name: '広島中学校 小学理科 第4回', subject: '小学理科', requiredHours: 17, deadline: '2026-04-26', status: 'submitted', sheetsUrl: '', workType: '解答出し', createdAt: '2026-04-16T00:00:00.000Z' },
    { id: 't61', name: '桜が丘中学校 小学社会 第5回', subject: '小学社会', requiredHours: 18, deadline: '2026-04-27', status: 'pending', sheetsUrl: '', workType: '部分点', createdAt: '2026-04-17T00:00:00.000Z' },
    ...
    { id: 't63', name: '城北中学校 小学国語 第5回', subject: '小学国語', requiredHours: 20, deadline: '2026-04-29', status: 'approved', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-04-19T00:00:00.000Z' },
    { id: 't64', name: '西園中学校 小学算数 第5回', subject: '小学算数', requiredHours: 4, deadline: '2026-04-30', status: 'in_progress', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-04-20T00:00:00.000Z' },
    { id: 't65', name: '東京学園 小学理科 第5回', subject: '小学理科', requiredHours: 5, deadline: '2026-03-10', status: 'pending', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-01T00:00:00.000Z' },
    { id: 't66', name: '大阪附属中 小学社会 第5回', subject: '小学社会', requiredHours: 6, deadline: '2026-03-11', status: 'in_progress', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-01T00:00:00.000Z' },
    ...
    { id: 't68', name: '横浜中学校 小学国語 第5回', subject: '小学国語', requiredHours: 8, deadline: '2026-03-13', status: 'assigned', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-03T00:00:00.000Z' },
    { id: 't69', name: '神戸中学校 小学算数 第5回', subject: '小学算数', requiredHours: 9, deadline: '2026-03-14', status: 'in_progress', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-04T00:00:00.000Z' },
    { id: 't70', name: '千葉中学校 小学理科 第5回', subject: '小学理科', requiredHours: 10, deadline: '2026-03-15', status: 'submitted', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-05T00:00:00.000Z' },
    { id: 't71', name: '埼玉中学校 小学社会 第5回', subject: '小学社会', requiredHours: 11, deadline: '2026-03-16', status: 'pending', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-06T00:00:00.000Z', viking: true },
    ...
    { id: 't73', name: '桜が丘中学校 小学国語 第6回', subject: '小学国語', requiredHours: 13, deadline: '2026-03-18', status: 'pending', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-08T00:00:00.000Z' },
    { id: 't74', name: '青山中学校 小学算数 第6回', subject: '小学算数', requiredHours: 14, deadline: '2026-03-19', status: 'pending', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-09T00:00:00.000Z' },
    { id: 't75', name: '城北中学校 小学理科 第6回', subject: '小学理科', requiredHours: 15, deadline: '2026-03-20', status: 'pending', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-10T00:00:00.000Z' },
    { id: 't76', name: '西園中学校 小学社会 第6回', subject: '小学社会', requiredHours: 16, deadline: '2026-03-21', status: 'submitted', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-11T00:00:00.000Z' },
    ...
    { id: 't78', name: '大阪附属中 小学国語 第6回', subject: '小学国語', requiredHours: 18, deadline: '2026-03-23', status: 'pending', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-13T00:00:00.000Z' },
    { id: 't79', name: '名古屋中学校 小学算数 第6回', subject: '小学算数', requiredHours: 19, deadline: '2026-03-24', status: 'submitted', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-14T00:00:00.000Z' },
    { id: 't80', name: '横浜中学校 小学理科 第6回', subject: '小学理科', requiredHours: 20, deadline: '2026-03-25', status: 'assigned', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-15T00:00:00.000Z' },
    { id: 't81', name: '神戸中学校 小学社会 第6回', subject: '小学社会', requiredHours: 4, deadline: '2026-03-26', status: 'approved', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-16T00:00:00.000Z' },
    ...
    { id: 't83', name: '埼玉中学校 小学国語 第6回', subject: '小学国語', requiredHours: 6, deadline: '2026-03-28', status: 'pending', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-18T00:00:00.000Z' },
    { id: 't84', name: '広島中学校 小学算数 第6回', subject: '小学算数', requiredHours: 7, deadline: '2026-03-29', status: 'approved', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-19T00:00:00.000Z' },
    { id: 't85', name: '桜が丘中学校 小学理科 第7回', subject: '小学理科', requiredHours: 8, deadline: '2026-03-30', status: 'in_progress', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-20T00:00:00.000Z' },
    { id: 't86', name: '青山中学校 小学社会 第7回', subject: '小学社会', requiredHours: 9, deadline: '2026-03-31', status: 'approved', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-21T00:00:00.000Z', viking: true },
    ...
    { id: 't88', name: '西園中学校 小学国語 第7回', subject: '小学国語', requiredHours: 11, deadline: '2026-04-02', status: 'approved', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-23T00:00:00.000Z' },
    { id: 't89', name: '東京学園 小学算数 第7回', subject: '小学算数', requiredHours: 12, deadline: '2026-04-03', status: 'assigned', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-24T00:00:00.000Z' },
    { id: 't90', name: '大阪附属中 小学理科 第7回', subject: '小学理科', requiredHours: 13, deadline: '2026-04-04', status: 'submitted', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-25T00:00:00.000Z' },
    { id: 't91', name: '名古屋中学校 小学社会 第7回', subject: '小学社会', requiredHours: 14, deadline: '2026-04-05', status: 'submitted', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-26T00:00:00.000Z' },
    ...
    { id: 't93', name: '神戸中学校 小学国語 第7回', subject: '小学国語', requiredHours: 16, deadline: '2026-04-07', status: 'submitted', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-03-28T00:00:00.000Z' },
    { id: 't94', name: '千葉中学校 小学算数 第7回', subject: '小学算数', requiredHours: 17, deadline: '2026-04-08', status: 'assigned', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-03-29T00:00:00.000Z' },
    { id: 't95', name: '埼玉中学校 小学理科 第7回', subject: '小学理科', requiredHours: 18, deadline: '2026-04-09', status: 'assigned', sheetsUrl: '', workType: '解答出し', createdAt: '2026-03-30T00:00:00.000Z' },
    { id: 't96', name: '広島中学校 小学社会 第7回', subject: '小学社会', requiredHours: 19, deadline: '2026-04-10', status: 'approved', sheetsUrl: '', workType: '部分点', createdAt: '2026-03-31T00:00:00.000Z' },
    ...
    { id: 't98', name: '青山中学校 小学国語 第8回', subject: '小学国語', requiredHours: 4, deadline: '2026-04-12', status: 'pending', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-04-02T00:00:00.000Z' },
    { id: 't99', name: '城北中学校 小学算数 第8回', subject: '小学算数', requiredHours: 5, deadline: '2026-04-13', status: 'in_progress', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-04-03T00:00:00.000Z' },
    { id: 't100', name: '西園中学校 小学理科 第8回', subject: '小学理科', requiredHours: 6, deadline: '2026-04-14', status: 'submitted', sheetsUrl: '', workType: '解答出し', createdAt: '2026-04-04T00:00:00.000Z' },
    { id: 't101', name: '東京学園 小学社会 第8回', subject: '小学社会', requiredHours: 7, deadline: '2026-04-15', status: 'pending', sheetsUrl: '', workType: '部分点', createdAt: '2026-04-05T00:00:00.000Z' },
    ...
    { id: 't103', name: '名古屋中学校 小学国語 第8回', subject: '小学国語', requiredHours: 9, deadline: '2026-04-17', status: 'approved', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-04-07T00:00:00.000Z' },
    { id: 't104', name: '横浜中学校 小学算数 第8回', subject: '小学算数', requiredHours: 10, deadline: '2026-04-18', status: 'pending', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-04-08T00:00:00.000Z', viking: true },
    { id: 't105', name: '神戸中学校 小学理科 第8回', subject: '小学理科', requiredHours: 11, deadline: '2026-04-19', status: 'pending', sheetsUrl: '', workType: '解答出し', createdAt: '2026-04-09T00:00:00.000Z' },
    { id: 't106', name: '千葉中学校 小学社会 第8回', subject: '小学社会', requiredHours: 12, deadline: '2026-04-20', status: 'assigned', sheetsUrl: '', workType: '部分点', createdAt: '2026-04-10T00:00:00.000Z' },
    ...
    { id: 't108', name: '広島中学校 小学国語 第8回', subject: '小学国語', requiredHours: 14, deadline: '2026-04-22', status: 'assigned', sheetsUrl: '', workType: '新年度試験種', createdAt: '2026-04-12T00:00:00.000Z' },
    { id: 't109', name: '桜が丘中学校 小学算数 第9回', subject: '小学算数', requiredHours: 15, deadline: '2026-04-23', status: 'approved', sheetsUrl: '', workType: 'タグ付け', createdAt: '2026-04-13T00:00:00.000Z' },
    { id: 't110', name: '青山中学校 小学理科 第9回', subject: '小学理科', requiredHours: 16, deadline: '2026-04-24', status: 'pending', sheetsUrl: '', workType: '解答出し', createdAt: '2026-04-14T00:00:00.000Z' },
    { id: 't111', name: '城北中学校 小学社会 第9回', subject: '小学社会', requiredHours: 17, deadline: '2026-04-25', status: 'pending', sheetsUrl: '', workType: '部分点', createdAt: '2026-04-15T00:00:00.000Z' },
  ...
  verificationItems: [
    ...
    { id: 'vi4', name: '漢字の正誤確認', description: '漢字の正誤判定が正しいか', subject: '小学国語', sortOrder: 1, isRequired: true, purpose: 'verification', workType: null, createdAt: '2026-01-01T00:00:00.000Z' },
    { id: 'vi5', name: '計算過程の確認', description: '途中式の採点が正しいか', subject: '小学算数', sortOrder: 1, isRequired: true, purpose: 'verification', workType: null, createdAt: '2026-01-01T00:00:00.000Z' },
  ],
  feedbacks: [],
  fields: [
    // 理科 - 化学
...
export const initStorage = () => {
  if (!localStorage.getItem(STORAGE_KEY)) {
    ...
    if (!data._demoExamInputV1) {
      ...
      if (suzuki) suzuki.subjects = ['小学算数', '小学理科', '小学国語', '小学社会'];

      // デモタスク4件
      const demoTasks = [
        { id: 'td_sansu', name: '成城学園 小学算数 第1回', schoolId: 's1', subject: '小学算数', workType: '新年度試験種', status: 'assigned', assignedHours: 12, deadline: '2026-04-10', createdAt: '2026-03-12T00:00:00.000Z', note: '新年度試験種デモ' },
        { id: 'td_kokugo', name: '浅野 小学国語 第1回', schoolId: 's2', subject: '小学国語', workType: '新年度試験種', status: 'assigned', assignedHours: 15, deadline: '2026-04-12', createdAt: '2026-03-12T00:00:00.000Z', note: '新年度試験種デモ' },
        { id: 'td_shakai', name: '渋谷教育学園幕張 小学社会 第1回', schoolId: 's3', subject: '小学社会', workType: '新年度試験種', status: 'assigned', assignedHours: 10, deadline: '2026-04-08', createdAt: '2026-03-12T00:00:00.000Z', note: '新年度試験種デモ' },
        { id: 'td_rika', name: 'サレジオ学院 小学理科 第1回', schoolId: 's4', subject: '小学理科', workType: '新年度試験種', status: 'assigned', assignedHours: 14, deadline: '2026-04-15', createdAt: '2026-03-12T00:00:00.000Z', note: '新年度試験種デモ' },
      ];
      const existingTaskIds = new Set((data.tasks || []).map(t => t.id));
      ...
      const demoExamInputs = [
        // 算数 - 成城学園
        { id: 'ei_sansu', taskId: 'td_sansu', userId: 'u3', status: 'draft', 年度: '2017', 学校名: '成城学園', 回数: '1', 科目: '小学算数', 試験時間: '50分',
          大問リスト: [
        ...
        // 国語 - 浅野
        { id: 'ei_kokugo', taskId: 'td_kokugo', userId: 'u3', status: 'draft', 年度: '2024', 学校名: '浅野', 回数: '1', 科目: '小学国語', 試験時間: '',
          大問リスト: [
        ...
        // 社会 - 渋谷教育学園幕張
        { id: 'ei_shakai', taskId: 'td_shakai', userId: 'u3', status: 'draft', 年度: '2023', 学校名: '渋谷教育学園幕張', 回数: '1', 科目: '小学社会', 試験時間: '',
          大問リスト: [
        ...
        // 理科 - サレジオ学院
        { id: 'ei_rika', taskId: 'td_rika', userId: 'u3', status: 'draft', 年度: '2024', 学校名: 'サレジオ学院', 回数: '1', 科目: '小学理科', 試験時間: '40分',
          大問リスト: [
